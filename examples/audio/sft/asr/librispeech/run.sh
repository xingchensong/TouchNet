...
# exp_id="librispeech_1x16384_fullac_cp2_tp2_dp2_pp1_stack7_stride6_flex_packloss_mid_ar_std0.02_acc_normpreproc_wp2k_total260k_addpad_${model_config}_${exp_suffix}"
